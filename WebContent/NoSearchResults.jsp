            ...
            <div class="navbar navbar-default">
              <div class="container-fluid">
                <div class="navbar-header">
                  ...
                  <a class="navbar-brand" href="javascript:void(0)">Tutors and Students</a>
                </div>
                <div class="navbar-collapse collapse navbar-responsive-collapse">
                  <ul class="nav navbar-nav">
                    <li class="active"><a href="javascript:void(0)">Registration</a></li>
...
<div class="well bs-component">
    <div class="row">
      ...
      <div class="col-md-3">
	   ...
	   <center>
		<div class ="col-md-6">
		<h3> Looks like we have found 0 tutors !</h3>
		<br>
		<h3>Sorry. Please go <a href="search.html">back</a></h3>
         </div></center>
      <div class="col-md-3">
       </div>
       </form>
