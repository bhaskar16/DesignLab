    ...
    <div class="row">
      <div class="col-md-12">
        <div class="page-header">
          <h1 id="forms">Add achievements</h1>
        </div>
      </div>
    </div>
	   ...
	   <center>
		<div class ="col-md-6">
		 ...
		 <input type="hidden" name="type" value="achievements">
               ...
               <div class="form-group">
                <label for="textArea" class="col-md-2 control-label">Enter your Achievement(s)</label>

                <div class="col-md-10">
                  <input type="text" class="form-control" rows="3" id="textArea" name="achievement" required>
                </div>
              </div>
...
<br>
 <%@ page import="com.Cerebro.Controller.*" %>
		...
		if(k <= 0) {
			out.println("<h3>You have not Added any achievements.</h3>");
		}
    	int i =0;
    	while(i<k){
      %>
    ...
    <div class="row">
      ...
      <div class="col-md-3">
	   ...
	   <center>
		<div class ="col-md-6">
		 <div class="form-group">
		 <center> <h3> <% out.print(session.getAttribute("Achievements"+i)); %></h3>
                </center>
              </div>
      <div class="col-md-3">
       </div>
