            ...
            <div class="navbar navbar-default">
              <div class="container-fluid">
                <div class="navbar-header">
                  ...
                  <a class="navbar-brand" href="AgencyDashboard">Tutors and Students</a>
                </div>
...
<div class="well bs-component">
    <div class="row">
      ...
      <div class="col-md-3">
          ...
          <form class="form-horizontal" action="ManageTutors" method="post">
	   <center>
		<div class ="col-md-6">
		 <div class="form-group">
		 <input type="hidden" name="type" value="removeTutor">
                 <%
 String a = request.getParameter("ID"); 
 session.setAttribute("TEmail",session.getAttribute("TEmail"+a));
 String Agent = session.getAttribute("AgentID").toString();
 session.setAttribute("AgentID", Agent); %>
 
        <center><p>Do you wish to remove  <% out.print(session.getAttribute("TEmail")); %> ?</p></center>
<center>
		 <div class="form-group">
