...
================================================== -->
    ...
    <div class="row">
	  ...
	  <hr>
	  <a href="UpdateAgent.jsp" class="btn btn-raised btn-primary">Update Profile</a>
	  <a href="RegisterAgentTutor.html" class="btn btn-raised btn-warning">Register Tutor</a>
	 <form action="ProfileHandler" method="post">
		<input type="hidden" name="type" value="listtutors">
		<input type="submit" class="btn btn-raised btn-success" value="List My tutors"></input>
	 </form>
     </div>
        ...
        <div class="bs-component">
          <table class="table table-striped table-hover ">
            ...
            <tr class="info">
              ...
              <td><% out.print(session.getAttribute("ContactPerson")); %></td>
