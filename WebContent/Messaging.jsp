...
================================================== -->
  ...
  <div class="container">
       ...
       <div class="form-group">
            <label class="control-label" for="addon1">Send a text</label>
            <div class="input-group">
              <span class="input-group-addon"></span>
             <form action="NegotiationHandler" method="post"> <input type="hidden" name="type" value="sendMessage">
             <input type="text" id="addon1" class="form-control" name="mBody" required>
...
<center> 
    ...
    int length = Integer.parseInt(session.getAttribute("mlength").toString());
...
%>
	  <div class="well">
		<div class="bs-docs-section">
	<%  out.println(session.getAttribute("Sender"+i)); %>
	<%  out.println(session.getAttribute("Date"+i)); %>
	<%  out.println(session.getAttribute("Body"+i)); %>
