            ...
            <div class="navbar navbar-default">
              <div class="container-fluid">
                <div class="navbar-header">
                  ...
                  <a class="navbar-brand" href="ITutorDashboard.jsp">Tutors and Students</a>
                </div>
                <div class="navbar-collapse collapse navbar-responsive-collapse">
                  <ul class="nav navbar-nav">
                    <li class="active"><a href="ITutorDashboard.jsp">Back</a></li>
				  </ul>
    ...
    <div class="row">
      <div class="col-md-6">
        <div class="well bs-component">
          <form id="frm" onsubmit="return validateForm()" class="form-horizontal" name="updateTutor" action="ProfileHandler" method = "post">
            <fieldset>
              <legend>Tutors</legend>
              <input type="hidden" name="type" value="updateTutor">
			  <div class="form-group">
                <label for="inputName" class="col-md-2 control-label">Name</label>

                <div class="col-md-10">
                  <input type="text" class="form-control" id="inputName" placeholder="Name" name="name" value = "<%=session.getAttribute("Name") %>">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-10">
                  <input type="date" class="form-control" id="inputDob" placeholder="Date of birth" name="db" value = "<%=session.getAttribute("dob") %>">
                </div>
              </div>
              <!--<div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-md-10">
                  <input type="password" class="form-control" id="inputPassword" placeholder="Password" name="pass" value = "<%=session.getAttribute("pass") %>">
			   ...
			   <div class="form-group">
                ...
                <div class="col-md-10">
                  <textarea class="form-control" rows="3" id="textArea" placeholder="Address" name="address" ><%=session.getAttribute("Address") %></textarea>
			  ...
			  <div class="form-group">
                ...
                <div class="col-md-10">
                  <input type="text" class="form-control" id="inputPhone" placeholder="Mob. Number" name="contact" value = "<%=session.getAttribute("Contact") %>">
                </div>
              </div>
			  <div class="form-group">
                ...
                <div class="col-md-10">
				  ...
				  <div class="radio radio-primary">
					...
					<div id="locrow" style="display:none;">
						<input class="form-control" name="locbox" type="text" placeholder="Enter Location" value = "<%=session.getAttribute("location") %>"></input>
					</div>
				</div>
              </div>
            </fieldset>
         ...
         <div class="form-group">
          ...
          <div class="form-group">
           ...
           <div class="form-group">
            ...
            <input type="text" class="form-control" id="inputdesc" name="desc" value = "<%=session.getAttribute("Description") %>">
          </div>
		 <div class="form-group">
                <div class="col-md-10 col-md-offset-2">
                  <button type="button" onclick="window.location.href='ITutorDashboard.jsp'"class="btn btn-warning">Cancel</button>
