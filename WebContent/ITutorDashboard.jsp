<html>
  ...
  <!-- authors : Bhaskar Ghosh Dastidar -->
<head>
  <title>Independent Tutor Dashboard</title>
  <meta charset="utf-8">
...
$.material.init();
              ...
              <div class="container-fluid">
                ...
                <div class="navbar-collapse collapse navbar-responsive-collapse">
                  <ul class="nav navbar-nav">
                    <li class="active"><a href="ITutorDashboard.jsp">Home</a></li>
 ...
 <% session.setAttribute("TEmail", session.getAttribute("Email")); %>
    ...
    <div class="row">
	  ...
	  <hr>
	  <a href="UpdateTutor.jsp" class="btn btn-raised btn-primary">Update Profile</a>
        ...
        <div class="bs-component">
          <table class="table table-striped table-hover ">
            ...
            <tr class="danger">
              <td>6</td>
              <td>Discipline</td>
              <td><% out.print(session.getAttribute("Dis")); %></td>
             
            </tr>
            <tr class="danger">
              <td>7</td>
              <td>SubDiscipline</td>
              <td><% out.print(session.getAttribute("SubDis")); %></td>
             
			 <%
			 
				String dslot = "", ds = (String) session.getAttribute("DS");int dscnt = 0;
            ...
            <tr class="danger">
              <td>9</td>
              <td>Time Slot</td>
              <td><% out.print(session.getAttribute("TS")); %></td>
             
            </tr>
            <tr class="danger">
              <td>10</td>
              <td>Experience</td>
              <td><% out.print(session.getAttribute("Exp")); %></td>
             
            </tr>
            <tr class="danger">
              <td>11</td>
              <td>Remuneration</td>
              <td><% out.print(session.getAttribute("Rem")); %></td>
            ...
            <tr class="danger">
              <td>13</td>
              <td>Batch Size</td>
              <td><% out.print(session.getAttribute("BS")); %></td>
