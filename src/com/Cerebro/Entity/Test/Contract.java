...
public class Contract {
	...
	public Message[] getAllMessages() {
		...
		String sql = "SELECT * FROM messages WHERE contract_id = " + db_id + " ORDER BY date DESC";
		try {
			con = DB_SERVER.getConnection();stmt = con.createStatement();
	...
	public boolean cancel() {
		...
		try {
			con = DB_SERVER.getConnection();stmt = con.createStatement();
			String sql = "SELECT status FROM contracts WHERE contract_id = " + db_id;
	...
	public boolean proposeClosure(long id) {
		...
		try {
			con = DB_SERVER.getConnection();stmt = con.createStatement();
			String sql = "SELECT * FROM contracts WHERE contract_id = " + db_id;
			ResultSet rs = stmt.executeQuery(sql);boolean proceed = true;
	...
	public boolean updateContract(double rem, String ds, String ts, String loc, String bs, long tut_id) {
		Connection con = null;Statement stmt = null;boolean flag = false;
		try {
			con = DB_SERVER.getConnection();stmt = con.createStatement();
			...
			while(rs.next()) {
				...
				+ "'WHERE id = " + db_id;stmt.executeUpdate(sql);flag = true;
			} else {flag = false;}
		} catch(Exception e){e.printStackTrace();flag = false;}
		finally {
			try{
